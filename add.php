...
<head>
    ...
    <title>Dashboard - Daftar Pelanggan</title>
    ...
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="./list.php"><img src="./assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
                        </div>
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>Formulir Tambah Pengunjung</h3>
            </div>
            <div class="page-content">
                <a href="./list.php" class="btn btn-danger mb-3"><i class="bi bi-arrow-return-left"></i> Kembali</a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control" name="nama_barang" placeholder="Nama Pelanggan" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="contact-info-vertical">Jumlah</label>
                                    <input type="number" id="contact-info-vertical" class="form-control" name="jumlah" placeholder="Nomor Telepon" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
